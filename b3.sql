...
CREATE TABLE listagem (
	...
	list_percentual DECIMAL(6,3) CHECK(list_percentual BETWEEN 0.000 AND 100.000) NOT NULL,
...
CREATE TABLE cotacao (
    ...
    cot_pabertura DECIMAL NOT NULL,
    cot_pmax DECIMAL NOT NULL,
    cot_pfechamento DECIMAL NOT NULL,
    cot_qtdnegocios INT NOT NULL,
    cot_qtdacoes INT NOT NULL,
    cot_volumefin DECIMAL NOT NULL,
